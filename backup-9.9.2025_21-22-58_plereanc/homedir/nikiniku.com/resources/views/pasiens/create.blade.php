        ...
        <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            <form action="{{ route('pasiens.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="id_pasien" name="id_pasien" value="{{ old('nama_pasien') }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="nohp" name="nohp" value="{{ old('nohp') }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                </div>
